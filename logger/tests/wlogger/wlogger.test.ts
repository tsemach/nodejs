...
const logger = Logger.get('wlogger-test')
...
function printCurrentId(name: string) {
  ...
  logger.trace('TTTTTTTTTTTTTTTTTTTTTT this is trace message')
  // logger.silly('this is trace message')
}
...
logger.info('aaaaaaaaaaaaaaa, a:', a)
logger.error('ERROR aaaaaaaaaaaaaaa, a:', a)
logger.fatal('FATAL aaaaaaaaaaaaaaa, a:', a)
logger.fatal(`BACKTICK a is ${a} ${a}`)